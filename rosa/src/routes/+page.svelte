  ...
  <ion-card>
	<ion-card-header class="bg-blue-500">
		<ion-card-subtitle>things happened ermagerd!</ion-card-subtitle>
		<ion-card-title>Welcome to your app!</ion-card-title>
	</ion-card-header>

	<img class="w-40 h-40 object-cover mx-auto object-center" alt="mei" src="https://cdn.donmai.us/sample/4f/fe/__rosa_and_snivy_pokemon_and_2_more_drawn_by_yomogi_black_elf__sample-4ffe5d700137055fbeff282453cd0093.jpg" />
